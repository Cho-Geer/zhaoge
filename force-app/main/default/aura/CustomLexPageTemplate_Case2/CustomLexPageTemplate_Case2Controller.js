({
    ...
    handleCssRerender: function(component, event, helper) {
        ...
        if (!component.get("v.scrollFlag")) {
                component.find("middleDiv").getElement().scrollIntoView(true);
    ...
    handleScroll: function (component, event, helper) {
        window.setTimeout($A.getCallback(() => {
            ...
            let topMiddleClientHeight = top.clientHeight + (middle.clientHeight * 0.5);
            let middle2 = component.find("middleDiv2");
            ...
            if(!component.get("v.scrollFlag") && scroller > 15 && scroller <= 300)component.find("middleDiv").getElement().scrollIntoView(true);    
        }),1000);
    },
